/*
 * File : ChangeMarkerStyleAction.java
 *
 * Project : Euclide
 *
 * ===========================================
...
import gui.panels.MarkerStyleEditPanel;

/**
 * adds a sheet to the current document, and creates the corresponding view.
 * @author Legland
 */
public class ChangeMarkerStyleAction extends EuclideAction {	
	...
	public ChangeMarkerStyleAction(EuclideGui gui, String name){
		super(gui, name);
	}
