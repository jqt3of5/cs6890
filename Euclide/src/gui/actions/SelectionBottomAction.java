/*
 * File : SelectionBottomAction.java
 *
 * Project : Euclide
 *
 * ===========================================
 ...
 * @author Legland
 */
public class SelectionBottomAction extends EuclideAction {	
	...
	public SelectionBottomAction(EuclideGui gui, String name){
		super(gui, name);
	}

	@Override
	public void actionPerformed(ActionEvent evt) {
		logger.info("Move selection to bottom");
