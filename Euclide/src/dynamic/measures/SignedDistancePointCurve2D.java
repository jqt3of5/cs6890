/* file : SignedDistancePointCurve2D.java
 * 
 * Project : geometry
 *
 * ===========================================
...
public class SignedDistancePointCurve2D extends DynamicMeasure2D {
	...
	public SignedDistancePointCurve2D(DynamicShape2D curve, DynamicShape2D point2){
		this.parent1 = curve;
		this.parent2 = point2;
	...
	public void update() {
		...
		this.measure.setValue(curve.getSignedDistance(point));
		this.defined = true;
	}
}
