/* file : DistancePointCurve2D.java
 * 
 * Project : geometry
 *
 * ===========================================
...
public class DistancePointCurve2D extends DynamicMeasure2D {
	...
	public DistancePointCurve2D(DynamicShape2D curve, DynamicShape2D point){
		this.parent1 = curve;
		this.parent2 = point;
	...
	public void update() {
		...
		this.measure.setValue(curve.getDistance(point));
		this.defined = true;
	}
}
