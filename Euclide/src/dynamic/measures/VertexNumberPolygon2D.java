/* file : VertexNumberPolygon2D.java
 * 
 * Project : geometry
 *
 * ===========================================
...
public class VertexNumberPolygon2D extends DynamicMeasure2D {

	private DynamicShape2D parent1;
	
	CountMeasure2D measure = new CountMeasure2D(0);
		
	public VertexNumberPolygon2D(DynamicShape2D polygon){
	...
	public void update() {
		...
		this.measure.setCount(polygon.getVertexNumber());
		this.defined = true;
	}
