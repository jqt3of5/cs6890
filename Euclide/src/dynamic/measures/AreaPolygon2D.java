...
public class AreaPolygon2D extends DynamicMeasure2D {

	private DynamicShape2D parent1;
	
	Measure2D measure = new Measure2D(0);
		
	public AreaPolygon2D(DynamicShape2D polygon){
	...
	public void update() {
		...
		this.measure.setValue(polygon.getArea());
		this.defined = true;
	}
