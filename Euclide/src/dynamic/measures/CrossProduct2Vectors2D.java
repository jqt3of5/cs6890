/* file : CrossProduct2Vectors2D.java
 * 
 * Project : geometry
 *
 * ===========================================
...
public class CrossProduct2Vectors2D extends DynamicMeasure2D{
	...
	public CrossProduct2Vectors2D(DynamicVector2D vector1, DynamicVector2D vector2){
		super();
		parent1 = vector1;
		parent2 = vector2;
	...
	public void update() {
		...
		this.measure.setValue(Vector2D.cross(v1, v2));
		this.defined = true;
	}
}
