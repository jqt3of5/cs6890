/* file : ClosedPolylinePointSet2D.java
 * 
 * Project : geometry
 *
 * ===========================================
 ...
 * @author dlegland
 */
public class ClosedPolylinePointSet2D extends DynamicShape2D {
	 ...
	 */
	public ClosedPolylinePointSet2D(DynamicShape2D pointSet) {
		super();
	...
	public void update(){
        ...
        ring = new LinearRing2D(pointSet.getPoints());
