 ...
 * @author dlegland
 */
public class PolygonNPoints2D extends DynamicShape2D {
	 ...
	 * 
	 * @param points
	 *            the point array creating the polygon
	 */
	public PolygonNPoints2D(DynamicShape2D[] points) {
		super();
	 ...
	 * 
	 * @param array
	 *            ShapeArray containing instances of DynamicShape2D which return
	 *            points.
	 */
	public PolygonNPoints2D(DynamicArray2D array) {
		super();
	...
	public void update() {
		...
		for (DynamicShape2D dyn : points) {
			...
			polygon.addVertex((Point2D) shape);
		}

		// Asssumes a polygon must contains at least 3 vertices
