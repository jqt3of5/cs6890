/*
 * File : Intersection2Polygons2D.java
 *
 * Project : geometry
 *
 * ===========================================
 ...
 * @author Legland
 */
public class Intersection2Polygons2D extends DynamicShape2D{
	 ...
	 */
	public Intersection2Polygons2D(
			DynamicShape2D poly1, DynamicShape2D poly2){
		super();
		this.parent1 = poly1;
		this.parent2 = poly2;
	...
	public void update(){
		...
		result = Polygon2DUtils.intersection(polygon1, polygon2);
