/* file : ClosedPolylineNPoints2D.java
 * 
 * Project : geometry
 *
 * ===========================================
 ...
 * @author dlegland
 */
public class ClosedPolylineNPoints2D extends DynamicShape2D {
	 ...
	 * @param point
	 */
	public ClosedPolylineNPoints2D(DynamicShape2D[] points) {
		super();
	...
	public void update(){
		...
		this.ring = new LinearRing2D(vertices);
		this.defined = true;
	}
}
