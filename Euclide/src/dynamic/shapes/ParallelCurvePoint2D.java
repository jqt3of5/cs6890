/*
 * File : ParallelCurvePoint2D.java
 *
 * Project : geometry
 *
 * ===========================================
 ...
 * @author Legland
 */
public class ParallelCurvePoint2D extends DynamicShape2D{
	...
	public ParallelCurvePoint2D(DynamicShape2D line, 
			DynamicShape2D distanceMeasure){
		super(); //
		this.parent1 = line;
	...
	public void update(){
        ...
        double distance;
        if (curve instanceof OrientedCurve2D) {
        	distance = ((OrientedCurve2D) curve).getSignedDistance(point);
        } else {
        	distance = curve.getDistance(point);
        }
	...
	//TODO: remove code redundancies with ParallelCurveDistance2D
