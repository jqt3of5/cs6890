 ...
 * @author dlegland
 */
public class ShapeLocus2D extends DynamicShape2D {
	
	DynamicShape2D parent1;
	
	CurveArray2D<Curve2D> curveSet = new CurveArray2D<Curve2D>();
	
	public ShapeLocus2D(DynamicShape2D curve){
		this.parent1 = curve;
