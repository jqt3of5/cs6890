 ...
 * @author Legland
 */
public class ParallelLine2D extends DynamicShape2D{
	...
	public ParallelLine2D(DynamicShape2D baseLine, DynamicShape2D point){
		super();
	...
	public void update(){
		...
		line = new StraightLine2D(x0, y0, vect.getX(), vect.getY());
		this.defined = true;
	}
}
