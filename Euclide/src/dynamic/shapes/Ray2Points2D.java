 ...
 * @author dlegland
 */
public class Ray2Points2D extends DynamicShape2D {

	DynamicShape2D parent1;
	DynamicShape2D parent2;
	
	Ray2D ray = new Ray2D(0, 0, 0, 0);
	 ...
	 * @param point2
	 */
	public Ray2Points2D(DynamicShape2D point1, DynamicShape2D point2) {
		super();
		this.parent1 = point1;
		this.parent2 = point2;
	...
	public void update() {
		...
		this.ray = new Ray2D(point1, direction);
		this.defined = true;		
	}
}
