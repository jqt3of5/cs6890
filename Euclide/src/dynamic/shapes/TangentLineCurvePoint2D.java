/* file : TangentLineCurvePoint2D.java
 * 
 * Project : geometry
 *
 * ===========================================
 ...
 * @author dlegland
 */
public class TangentLineCurvePoint2D extends DynamicShape2D {
	 ...
	 * @param point
	 */
	public TangentLineCurvePoint2D(DynamicShape2D curve, DynamicShape2D point) {
		this.parent1 = curve;
		this.parent2 = point;
	...
	public void update(){
		...
		line = new StraightLine2D(p0, vect);
		this.defined = true;
	}
}
